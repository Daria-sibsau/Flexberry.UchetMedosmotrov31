    ...
    public class Подразделения : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПодразделенияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразделенияE", typeof(IIS.UchetMedosmotrov3.Подразделения));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПодразделенияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразделенияL", typeof(IIS.UchetMedosmotrov3.Подразделения));
                }
            }
        }
    }
