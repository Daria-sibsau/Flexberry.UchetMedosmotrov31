...
namespace IIS.UchetMedosmotrov3
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov3.ПолСотрудника fПол;
        ...
        private IIS.UchetMedosmotrov3.Должности fДолжности;
        ...
        public virtual IIS.UchetMedosmotrov3.ПолСотрудника Пол
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.ПолСотрудника result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.Должности Должности
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.UchetMedosmotrov3.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.UchetMedosmotrov3.Сотрудники));
                }
            }
        }
    }
