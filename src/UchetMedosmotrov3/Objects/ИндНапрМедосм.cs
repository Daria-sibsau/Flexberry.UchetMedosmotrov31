...
namespace IIS.UchetMedosmotrov3
{
    ...
    public class ИндНапрМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov3.МедУчреждение fМедУчреждение;
        ...
        [PropertyStorage(new string[] {
                "МедУчреждение"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.МедУчреждение МедУчреждение
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.МедУчреждение result = this.fМедУчреждение;
