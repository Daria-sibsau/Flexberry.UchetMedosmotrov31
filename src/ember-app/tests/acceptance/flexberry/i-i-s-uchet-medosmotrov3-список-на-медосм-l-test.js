...
moduleForAcceptance('[AGAT] Acceptance | i i s uchet medosmotrov3 список на медосм l');

test('testing i-i-s-uchet-medosmotrov3-список-на-медосм-l', function(assert) {
