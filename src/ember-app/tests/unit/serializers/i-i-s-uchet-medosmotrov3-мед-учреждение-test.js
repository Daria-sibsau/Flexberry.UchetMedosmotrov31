...
moduleForModel('i-i-s-uchet-medosmotrov3-мед-учреждение', 'Unit | Serializer | i-i-s-uchet-medosmotrov3-мед-учреждение', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov3-мед-учреждение',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
